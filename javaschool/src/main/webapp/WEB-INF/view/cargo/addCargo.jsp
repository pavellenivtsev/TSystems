    ...
    <form action="${var}" method="post" id="form" class="form-horizontal">
        ...
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
                <button class="btn btn-default" type="submit" id="form_add_cargo">Add cargo</button>
            </div>
        </div>
        ...
        <input type="text" style="visibility: hidden" id="unloadingLatitude" name="unloadingLatitude" required>
